...
const Sidebar: FC<SidebarProps> = ({
  ...
  // 重命名对话
  const handleRenameDialogue = useCallback(
    async (dialogueId: string, newTitle: string) => {
                ...
                ...dialogues.map((dialogue) => (
                  <div
                    ...
                    onClick={(e) => {
                      ...
                      if (
                        !target.closest('.dialogue-actions') &&
                        !target.closest('.dialogue-menu')
                      ) {
                      ...
                      {editingId === dialogue.id ? (
                        ...
                        <>
                          <div className="dialogue-title">
                            {dialogue.title || t('dialogue.defaultTitle')}
                          </div>
                          <div className="dialogue-meta">
                            <span className="dialogue-time">
                              {new Date(
                                dialogue.update_time,
                              ).toLocaleDateString()}
                            </span>
                            <div className="dialogue-model">
                              {(() => {
                                const models = parseMultipleModels(
                                  dialogue.model,
                                );
                    ...
                    <div className="dialogue-actions">
                      <button
                        ...
                        onClick={(e) => {
                          ...
                          const dialogueItemElement =
                            buttonElement.closest('.dialogue-item');
                          if (dialogueItemElement) {
                            const rect =
                              dialogueItemElement.getBoundingClientRect();
                          ...
                          setOpenMenuId(
                            openMenuId === dialogue.id ? null : dialogue.id,
                          );
                        }}
                      ...
                      {openMenuId === dialogue.id && (
                        <div
                          className={`dialogue-menu ${menuPosition === 'top' ? 'dialogue-menu-top' : ''}`}
                        >
                          <button
